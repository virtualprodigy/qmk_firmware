...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // F14 F15 F21-24 don't work in OBS 
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            KC_F13, KC_F16, KC_F17, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_F18, KC_F19, KC_F20 , \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   LAG(KC_LBRC), LAG(KC_RBRC), RSA(KC_PGDN), \
...
void matrix_init_user(void) {
    eeconfig_init(); //Clear EEPROM Z(Electrionically Erasable Progammable Read-Only Memory)
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case LOCK_MAC:
            ...
            // press keys to lock mac screen and then release then tap doesn't work
            SEND_STRING(SS_DOWN(X_LGUI)SS_DOWN(X_LCTL)SS_DOWN(X_Q)SS_UP(X_LGUI)SS_UP(X_LCTL)SS_UP(X_Q));
            return false;
        default:
