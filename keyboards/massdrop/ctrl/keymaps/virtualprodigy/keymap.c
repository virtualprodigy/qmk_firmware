...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            RSA(KC_PSCR), RSA(KC_SLCK), RSA(KC_PAUS), \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   RSA(KC_INS),  RSA(KC_HOME), RSA(KC_PGUP), \
